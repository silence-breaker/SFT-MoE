...
4.7 
Interference detection and optimization ........................................................................................................... 93 
4.7.1 
Background and goal of the use case .......................................................................................................... 95 
4.7.2 
Entities/resources involved in the use case ................................................................................................. 96 
4.7.3 
Solution ....................................................................................................................................................... 97 
4.7.4 
Required data .............................................................................................................................................. 99 
...
5.1.1 
Near-RT RIC generic functional requirements ......................................................................................... 102 
5.1.2 
E2 interface functional requirements ........................................................................................................ 102 
...
O-RAN.WG3.TS.UCR-R004-v09.00
5.1.3 
RAI exposure interface functional requirements ...................................................................................... 112 
5.2 
Non-functional requirements .......................................................................................................................... 113 
5.2.1 
Near-RT RIC non-functional requirements .............................................................................................. 113 
5.2.2 
E2 interface non-functional requirements ................................................................................................. 113 
Annex A (informative): Example use cases ................................................................................................... 114 
A.1 
Example use cases for RAN slice SLA assurance .......................................................................................... 114 
A.1.1 
Downlink and uplink throughput per slice ................................................................................................ 114 
A.1.2 
Guaranteed downlink and uplink throughput per slice ............................................................................. 115 
Annex (informative):  Change history/Change request (history) ................................................................... 116 
...
Specification” 
[39] 
O-RAN.WG4.MP.0-R004-v17.01: “O-RAN Working Group 4, Management Plane Specification” 
[40] 
...
[49] 
O-RAN.WG1.TS.Use-Cases-Detailed-Specification-R004-v16.00: “O-RAN Work Group 1 (Use Cases 
and Overall Architecture), Use Cases Detailed Specification” 
...
[i.6] 
O-RAN.WG1.TR.Use-Cases-Analysis-Report-R004-v16.00: “O-RAN Work Group 1 (Use Cases and 
Overall Architecture), Use Cases Analysis Report” 
3 
...
UE-level 
L2 
1. DL/UL PRB used for data traffic (as specified in O-RAN WG3 E2SM-KPM 
[36]) 
2. Average DL UE throughput in gNB (as specified in O-RAN WG3 E2SM-
KPM [36]) 
3. Distribution of DL UE throughput in gNB (as specified in O-RAN WG3 
E2SM-KPM [36]) 
4. Packet Delay (as specified in O-RAN WG3 E2SM-KPM [36]) 
5. DL/UL Cell PDCP SDU Data Volume (as specified in O-RAN WG3 E2SM-
KPM [36]) 
...
Measurement Type 
Measurement Examples 
6. Mean number of Active UEs in the DL/UL per cell (as specified in O-RAN 
WG3 E2SM-KPM [36]) 
7. Max number of Active UEs in the DL/UL per cell (as specified in O-RAN 
WG3 E2SM-KPM [36]) 
8. Packet Loss Rate (as specified in O-RAN WG3 E2SM-KPM [36]) 
9. DL Packet Drop Rate (as specified in O-RAN WG3 E2SM-KPM [36]) 
10. DRB-specific RLC buffer occupancy (as specified in O-RAN WG3 E2SM-
RC [37]) 
11. Serving cell and neighbor cell RRC measurements (as specified in O-
RAN WG3 E2SM-RC [37]) 
12. Number of DRBs and PDU sessions (as specified in O-RAN WG3 E2SM-
RC [37]) 
13. Number of QoS flows and QoS parameters of QoS flows mapped to 
each DRB (as specified in O-RAN WG3 E2SM-RC [37]) 
14. Number of HARQ TBs with specific MCS rates (as specified in O-RAN 
WG3 E2SM-KPM [36]) 
15. CQI (as specified in O-RAN WG3 E2SM-KPM [36]) 
16. Serving cell and neighbor cell RSRP (as specified in O-RAN WG3 E2SM-
KPM [36]) 
...
RA  ser ice consumer
RA  ser ice consumer
   RA  Su scription procedure for  oE optimi ation
2    E2>> R C Su scription procedure Report   easurements 
 oo 
        u  cr    o   er     e  
 oo 
      co  ec  o  
     E2>> R C  ndication  Report 
    rocess and store data
   RA  analytics information  eneration
   RA  Report  RA  analytics information 
RA  Su scription Delete procedure
  E2>> R C Su scription Delete procedure Report   easurements 
...
This use case provides the motivation, description, and requirements for the Near-RT RIC and E2 interface to support interference 
detection and optimization, whose end-to-end requirements are specified in [49]. 
3GPP LTE and 5G networks are deployed based on the design objective of having a frequency reuse factor of one for the whole 
network (i.e., all cells in a network use the same frequency) due to limited radio resources. As a result, there is a need to leverage 
...
O-RAN.WG3.TS.UCR-R004-v09.00
interference management techniques to mitigate inter-cell interference to improve QoS for users, especially at the cell edge. How 
to detect and then optimize interference is of great importance for cellular wireless networks. 
3GPP specifies multiple categories of interference management techniques to support interference optimization. The first 
category is based on the principle of inter-cell interference coordination. It has three sub-categories: Inter-Cell Interference 
Coordination (ICIC), enhanced ICIC (eICIC), and further enhanced ICIC (feICIC) where ICIC works in the frequency domain, 
eICIC in the time domain and feICIC in the UE domain. 
For ICIC, if the two-dimensional (in frequency and time) RBs for data channels to be scheduled in a cell can be shared and 
coordinated with other neighboring cells, interference of UEs near the cell edge can be mitigated. ICIC can leverage the following 
mechanisms. 
• 
Restricting scheduling RBs: The RBs used by a group of users in one geographical area (e.g., in the cell edge) for a cell 
is not scheduled by the neighboring cells. It is to avoid simultaneous transmission in the cell edge from neighboring 
cells. 
• 
Adjustment of the power level on physical channels. 
ICIC can be implemented in a static or dynamic way. Static ICIC is achieved when the network operator manually manages cell 
configurations which become overly complex in practical deployments and are typically slow to adapt to changes in the network. 
Dynamic ICIC is required for fast adaptation of the interference scenarios, and exchange of signaling messages over X2/Xn 
interfaces among neighboring cells to convey scheduling decisions are needed to support interference optimization [12][19]. The 
ICIC concept was the origin of PRB blanking. 
For UL, the High Interference Indicator (HII) and Overload Indicator (OI) are available [12]. The HII informs the neighboring 
cells of the RBs to be scheduled for UEs as a proactive mechanism. With this information, the neighboring cells can avoid 
scheduling the same RBs for the UEs near the interfering cell. The OI informs the neighboring cells of the interference levels 
received on various two-dimensional resources (low, medium and high) as a reactive mechanism. With this information, the 
neighboring cells can a) reduce transmit power level, b) not schedule those RBs for UEs near the cell edge or c) not schedule 
those RBs at all. 
For DL, the Relative Narrowband Transmit Power (RNTP) informs the neighboring cells of the transmit power level per RB, 
including the RNTP threshold and RNTP bitmap of all RBs [12]. In the RNTP bitmap each bit indicates if the transmit power of 
an RB would exceed the RNTP threshold. With this information, the power allocation for UEs near the cell edge can be 
dynamically adjusted in a coordinated way. 
A cell can request load measurements from neighboring cells via Resource Status Reporting where the load measurements 
include DL and UL PRB usages [19]. 
For eICIC, cells exchange coordinated messages with its neighbors to allow the scheduler to create Almost Blank Subframes 
(ABS) in the time domain to mitigate interference at the UEs. The ABS contains no data traffic, but common Reference Signals 
(RSs) are still transmitted. Muted subframes should be avoided in subframes that transmit critical information Critical control 
channels (including System Information Block [SIB] 1 and paging), and broadcast (Master Information Block [MIB]) 
information are required in these subframes to avoid radio link failure for legacy UEs. 
For feICIC (also called the terminal-based interference management technique), interference cancellation is implemented at the 
UE for the critical control physical channels or signals that eICIC cannot handle (e.g., synchronization signals, reference signals, 
broadcast channel, etc.). 
The second category of interference management is based on carrier aggregation. In carrier aggregation, multiple carriers are 
aggregated at a cell.  There are three types of carrier aggregation. 
• 
Contiguous aggregation of component carriers in a single band 
• 
Non-contiguous aggregation of component carriers in a single band 
• 
Non-contiguous aggregation of component carriers over multiple bands 
The original goal of carrier aggregation was to improve the data rate (i.e., throughput) for a UE since a UE can utilize multiple 
frequency carriers to communicate with a cell where the multiple frequency carriers can be from the same spectrum band or 
...
O-RAN.WG3.TS.UCR-R004-v09.00
different spectrum bands. However, carrier aggregation can also be used as an interference optimization mechanism to improve 
spectral energy dispersal. 
The third category is based on Coordinated Multipoint (CoMP), which works in the spatial domain. CoMP is for multiple cells 
to coordinate with each other to jointly transmit and receive information to a single UE. CoMP performs coordinated scheduling 
and beam forming on a UE to improve performance in an interference environment (by minimizing interference). CoMP is 
similar to the soft handover concept in Code Division Multiple Access (CDMA). 
To trigger interference optimization, interference detection (including detecting the interference energy, classifying the 
interference source types, identifying the interference levels, and locating the interference source in terms of a geographical 
location) is required. In addition to LTE and 5G interference, other non-3GPP types of interference experienced in a 5G network, 
including internal and external RF interference, also need to be detected and optimized.  
Thanks to the open interface, the virtualization and intelligent functionalities provided by the O-RAN architecture, multi-cell-
based collaborative real-time interference detection and optimization schemes can be realized. The operation and performance 
evaluation for interference detection and optimization in real-time should be conducted based on interference-related data 
focusing on a specific UE, UE group, RAN slice, PRBs or mMIMO beams, which is the primary target of improvement. The 
Near-RT RIC ensures optimal radio resource allocation for a UE, UE group, RAN slice, PRBs, and mMIMO beams through the 
E2 interface to improve the efficiency of radio resource utilization and interference optimization. 
4.7.1 
Background and goal of the use case 
More background information for interference detection can be found in [49][i.6]. 
Interference detection includes the following steps: 
• 
Detection of interference energy 
• 
Classification of interference source type 
• 
Identification of the interference level 
• 
Locating an interference source 
The data generated from E2 nodes to support interference detection can be based on the following: 
• 
...
• 
per direction (e.g., data is from the direction of multiple beams) 
• 
per UE or per group of UEs 
• 
per range (e.g., data is from those UEs within a certain range of a cell) 
• 
per pattern (e.g., uplink RSSIs pattern or uplink PRB interference pattern) 
where data per cell, per sector, per UE or per group of UEs have been supported in the O-RAN WG3 E2SM-KPM [36]. 
The xApps process the data from E2 nodes to support the interference detection objective. Specific data required include: 
1) Network level measurements, including  
a) UE level information: e.g., Channel State Information (CSI) reports including CQI (per UE or per UE slice), Precoding Matrix 
Indicator (PMI) with beam indicator, layer indication, rank indication as well as SINR, MCS, UL/DL RSRP, SS-RSRP (for 
serving cell and neighboring cells), SS-SINR, throughput, DU/UL PRB usage, mMIMO beams, Buffer Status Report (BSR), 
Power Headroom Report (PHR), location, velocity and timing advance. Note that to monitor CSI measurements for supporting 
channel measurement, channel estimation and interference measurement, E2 control or policy need to allocate cell resources and 
provide cells information transmission strategy for the serving cell and its intra-frequency neighboring cells for CSI-related RSs 
...
O-RAN.WG3.TS.UCR-R004-v09.00
including Non-Zero Power (NZP) CSI-RS and CSI Interference Measurement (CSI-IM) containing zero power resource elements 
[49]. 
b) Cell level information: e.g., DL/UL PRB usage, throughput, uplink interference including UL interference per cell, UL 
interference per PRB in a cell, and UL interference per PRB of an antenna branch per cell as specified in WG3 UCR use case 6. 
Note that to support UL interference per PRB in a cell, E2 control or policy needs to send information for the UL PRBs to be 
monitored. 
2) Received power measurements (i.e., Received Signal Strength Indicators [RSSIs]) from O-RU directly or indirectly via O-
DU as specified in [39], clause 21. 
After the xApps achieve the interference detection objective, the xApps determine a combination of the interference optimization 
mechanisms to achieve the interference optimization objective in real-time. The following is a list of interference optimization 
mechanisms that manage resources in time, frequency, space and power domains to achieve the objective of interference 
optimization. 
• 
Traditional cellular RF design techniques: antenna down-tilt and antenna azimuth orientation 
• 
Traditional cellular RF design technique: transmit power level adjustment at E2 node 
• 
Power control 
• 
PRB blanking 
...
CoMP 
• 
Beam control (including beam muting as beam forming such as beam nulling) 
For background information on the PRB blanking optimization, see clause 4.6.4 PRB blanking optimization. 
Carrier aggregation reduces interference by selecting the carriers with less interference to aggregate. 
CoMP reduces interference by selecting cells that experience less interference. 
Beam muting reduces interference in the spatial domain by muting one or more SSB beams and / or traffic beams in the MIMO 
Grid of Beams (GoB) mode. 
Beam forming reduces interference in the spatial domain by forming nulls to cancel interference in MIMO GoB and non-GoB 
modes. 
By analyzing the interference detection results, with the support of AI/ML, the Near-RT RIC sends control and / or policies 
regarding interference optimization mechanisms to an O-DU to influence the MAC scheduler behaviors for interference 
optimization in a network with multiple cells. The Near-RT RIC can achieve overall network performance improvements 
including interference optimization for both uplink and downlink with system-level optimization instead of local-level 
optimization by an O-DU alone. Furthermore, the AI/ML models' functionality in the Near-RT RIC can include prediction of 
future traffic, user mobility, resource usage, and QoS/QoE on a per UE basis as well as prediction of network performance and 
effectiveness of interference reduction for different interference optimization mechanisms. Based on the predicted results, 
interference optimization control and / or policy can be given by the Near-RT RIC to E2 nodes in a near-real-time manner. 
The interference optimization objective includes performance targets in QoS and interference reduction on a specific UE, UE 
group, RAN slice, PRBs or mMIMO beams such that the impact of interference on the QoS metric of a specific UE, UE group, 
RAN slice or cell can be reduced by a certain percentage. One example of the performance targets in QoS is the average DL 
throughput and UL throughput of the UEs near the cell edge to achieve. One example of performance targets in interference 
reduction is a 90% interference reduction target for a group of UEs in a cell which means that the average channel quality (e.g., 
CQI) for the specified group of UEs under interference can be improved by applying interference optimization mechanisms to a 
90% level compared to those when there is no interference. 
4.7.2 
Entities/resources involved in the use case 
1) 
Near-RT RIC: 
a) 
On-board and run interference detection and optimization xApps. 
...
O-RAN.WG3.TS.UCR-R004-v09.00
b) 
Near-real-time monitoring of interference detection and optimization related measurements from E2 nodes through 
E2 interface. 
c) 
Send controls and / or policies to E2 nodes through E2 interface to achieve the objectives of interference detection and 
optimization. 
2) 
E2 node: 
a) 
Support interference detection and optimization related measurements and reports through E2 interface. 
b) 
Support interference detection and optimization actions, configurations and / or policy enforcements from E2 interface. 
4.7.3 
Solution 
The context of interference detection and optimization is captured in table 4.7.3-1. 
Table 4.7.3-1: Interference detection and optimization 
Use Case Stage 
Evolution / Specification 
<<Uses>> 
Related use  
Goal 
Drive interference detection and optimization in accordance with information 
from the E2 nodes. 
...
Begins when 
Interference detection and optimization for performance targets, including QoS 
and interference reduction, is activated or an operator defined trigger is 
detected. 
 
Step 1 (M) 
Near RT RIC generates or updates interference detection and optimization 
control or policy.  
 
Step 2, 3 (M) 
Near-RT RIC sends interference detection control or policy including cell 
resources to allocate, cells information transmission strategy, and cell resources 
to be monitored to E2 nodes. 
 
Step 4 (M) 
Near-RT RIC collects data from E2 nodes through E2 interface. 
 
Step 5 (M) 
Near-RT RIC subscribes to UE context information and measurement metrics 
via E2 interface. 
...
Step 7 (M) 
Near-RT RIC evaluates the collected data from E2 nodes and finds potential 
performance targets improvements including QoS and interference reduction. 
 
Step 8, 9 (M) 
Near-RT RIC sends interference optimization control or policy to E2 nodes. 
 
Step 10 (M) 
Interference detection and optimization are deactivated, or an operator defined 
trigger is detected. 
 
Step 11 (M) 
Delete all related RIC subscriptions. 
 
Ends when 
Interference detection and optimization stops. 
 
Exceptions 
None. 
 
Post Conditions 
Interference detection and optimization over a period of time is achieved. 
 
Traceability 
REQ-Near-RT-RIC-ES-FUN7, REQ-Near-RT-RIC-IDIO-FUN1 
REQ-E2-QoS-FUN1, REQ-E2-QoS-FUN2, REQ-E2-QoS-FUN3, REQ-E2-
QoS-FUN4, REQ-E2-QoS-FUN5, REQ-E2-QoS-FUN6, REQ-E2-QoS-FUN7, 
REQ-E2-QoS-FUN8, REQ-E2-ES-FUN8, REQ-E2-ES-FUN9, REQ-E2-IDIO-
FUN1, REQ-E2-IDIO-FUN2, REQ-E2-IDIO-FUN3 
...
End box 
    ...
    near -> near: Near RT RIC generates or updates interference detection and optimization 
control or policy 
 
Alt Near-RT RIC uses CONTROL Service for interference detection 
 
near -> ran : <<E2>> RIC CONTROL REQUEST (Interference detection CONTROL) 
 
Else Near-RT RIC uses POLICY Service for interference detection 
 
near -> ran : <<E2>> RIC SUBSCRIPTION REQUEST (Interference detection POLICY) 
...
near <--> ran: <<E2>> RAN Data collection 
     near -> ran : <<E2>> RIC SUBSCRIPTION REQUEST (UE context & measurement metrics) 
     ran -> near: <<E2>> RIC REPORT or INDICATION (UE context & E2 measurement metrics) 
     near -> near: Evaluation, potential improvement to performance targets include QoS and 
interference reduction 
 
Alt Near-RT RIC uses CONTROL Service for interference optimization 
 
near -> ran : <<E2>> RIC CONTROL REQUEST (Interference optimization CONTROL) 
 
Else Near-RT RIC uses POLICY Service for interference optimization 
 
near -> ran : <<E2>> RIC SUBSCRIPTION REQUEST (Interference optimization POLICY) 
 
end 
near -> near: Interference detection and optimization stopped 
near-> ran: <<E2>> RIC SUBSCRIPTION DELETE 
@enduml 
 
The flow diagram of the performance targets optimization by interference detection and optimization is given in figure 4.7.3-1. 
...
O-RAN.WG3.TS.UCR-R004-v09.00
Figure 4.7.3-1: Performance targets optimization by interference detection and optimization 
4.7.4 
Required data 
This clause elaborates the Near-RT RIC and the E2 node capabilities necessary for implementation of the interference detection 
and optimization use case. The requirements are specified in clause 5. 
4.7.4.1 Control over E2 
1) Radio resource allocation. Near-RT RIC provides direct control for interference detection and optimization configurations 
to be applied at the E2 node. Configurations at the cell level include: 
- 
Configurations for cells resources allocation, cells information transmission strategy, and cell resources to be 
monitored to enable collection of interference detection related measurements. 
- 
Configurations of PRBs to be blanked in PRB blanking to support interference optimization (see clause 4.6.4 PRB 
blanking optimization). 
- 
Configurations of beam index (for both SSB beams and traffic beams) to be muted in beam muting to support 
interference optimization. 
- 
Configurations of carriers to be aggregated in carrier aggregation to support interference optimization. 
- 
Configurations of cells to be jointly used in CoMP to support interference optimization. 
Both RIC POLICY and RIC CONTROL can be used. 
2) Interference detection and optimization policy. Near-RT RIC provides policies to the E2 node including interference 
detection policies, interference optimization policies, and performance targets the interference optimization policies should 
achieve. The policies may include: 
- 
Preferred cells resources allocation, cells information transmission strategy, and cell resources to be monitored to enable 
collection to enable collection of interference detection related measurements. 
- 
Interference reduction target. 
- 
Cell-level and UE performance targets, e.g. throughput cap, throughput drop tolerance, latency target. 
- 
Preferred number of active or blanked PRBs to support PRB blanking optimization as part of interference optimization. 
- 
Preferred number of active or inactive carriers to support carrier aggregation optimization as part of interference 
optimization. 
- 
Preferred number of active or inactive cells to support CoMP optimization as part of interference optimization. 
- 
Preferred number of active or muted beams to support beam muting optimization as part of interference optimization. 
- 
Preferred number of nulls to support beam forming optimization as part of interference optimization. 
Either RIC POLICY or RIC CONTROL can be used. 
4.7.4.2 UE context information from E2 nodes 
The following items are examples of UE context information identified as required: 
- 
UE ID (as defined in [32])  
- 
Slice level: S-NSSAI 
- 
DRB level: e.g., established DRB ID, mapping with QoS flows, etc. 
...
O-RAN.WG3.TS.UCR-R004-v09.00
4.7.4.3 Measurements from E2 nodes 
The E2 measurements are necessary to support interference detection and optimization in the Near-RT RIC. For interference 
detection, the Near-RT RIC collects interference related measurements. The interference related measurements for assessing 
network interference conditions are evaluated against performance targets for the Near-RT RIC to produce interference 
optimization control and / or policy. 
The examples of measurements information identified as required are listed in table 4.7.4.3-1. 
Table 4.7.4.3-1: Measurements from E2 nodes 
Measurement 
Type 
Measurement Examples 
Cell/SSB area 
...
Slice Available Capacity Value 
- 
UL interference level per cell 
- 
UL interference level per PRB per cell 
- 
UL interference level per PRB per antenna branch per cell 
- 
Wideband CQI distribution (as specified in 3GPP TS 28.552 [6], clause 5.1.1.11.1) 
- 
SS-RSRP distribution per SSB for serving cell (as specified in 3GPP TS 28.552 [6], 
clause 5.1.1.22.1) 
- 
SS-RSRP distribution per SSB for neighbor cell (as specified in 3GPP TS 28.552 [6], 
clause 5.1.1.22.1) 
...
measurements 
- 
CSI (including CQI) measurements 
- 
SINR measurements 
- 
MCS measurements 
- 
RSRP, RSRQ, SS-RSRP, SS-SINR, SRS-RSRP, CSI-RSRP, CSI-SINR, CSI-RSRQ 
measurements 
- 
Location and Velocity measurements 
- 
...
As specified in 3GPP TS 38.331 [18], 3GPP TS 28.552 [6], 3GPP TS 38.215 [27] 
Mobility and RA 
related 
KPIs/measurements 
of UE/UE group 
...
O-RAN.WG3.TS.UCR-R004-v09.00
4.7.4.4 E2 node configuration 
Cell-level configuration parameters are needed at the Near-RT RIC to, for instance, configure UE measurements required for 
monitoring cell level performance to support interference detection and optimization. 
...
REQ-Near-RT-RIC-IDIO-
FUN1 
Near-RT RIC shall support interference detection and optimization 
...
REQ-E2-IDIO-FUN1 
E2 interface shall support forwarding the guidance of interference 
detection and optimization control and / or policy from the Near-
RT RIC to the E2 node. 
 
REQ-E2-IDIO-FUN2 
E2 interface shall support the configuration of interference 
detection and optimization objectives from the Near-RT RIC to the 
E2 node. 
 
REQ-E2-IDIO-FUN3 
E2 interface shall support the configuration and retrieval of 
interference detection and optimization related measurements 
and cell state information from the E2 node. 
...
- 
WG #    A reement of “    AO-2020.05.06-WG3-D-TS_UCR-TextProposal-
sect_up_to_      2_A   docx” 
- 
WG #    A reement of “    AO-2020.05.20-WG3-D-TS_UCR-TextProposal-
sect_       _OuterLoop_re _after_email_disc_ A    doc” 
- 
WG #    A reement of “    AO-2020.07.15-WG3-D-TS-
Descr+UpdatedRequirements_text-proposal_A  _C CC_RSY docx”; 
Inclusion of P1 and P3 of INT-2020.07.07-WG3-D-TextProposal-TS-UCR.doc 
- 
WG # 8  A reement of “    AO-2020.09.23-WG3-D-
...
2025.06.05 
08.00.01 
Initial version towards v09.00 
Addition of CR: 
- 
MTR.AO-2025.04.07-WG3-CR0004-UCR-Interference Detection and Optimization-
v4 
2025.07.08 
08.00.02 
Editorial corrections 
